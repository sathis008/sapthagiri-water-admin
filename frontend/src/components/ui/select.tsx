...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl border border-transparent py-2 pr-8 pl-3 text-sm font-medium outline-hidden select-none transition-colors duration-150 hover:bg-slate-100 focus:bg-slate-100 focus:text-slate-900 data-[state=checked]:bg-slate-200 data-[state=checked]:text-slate-900 data-[state=checked]:font-semibold not-data-[variant=destructive]:focus:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
