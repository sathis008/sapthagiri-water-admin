...
const CAPACITY_OPTIONS = ['12 KL', '24 KL', '32 KL', '40 KL', '50 KL', '60 KL', '80 KL', '100 KL'];

const STATUS_OPTIONS = ['AVAILABLE', 'ON_TRIP', 'MAINTENANCE', 'INACTIVE'];
      ...
      <CardContent className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <>
                <Input placeholder="TN58AB1234" {...field} />
        ...
        <div className="space-y-2">
          ...
          <Controller
            name="manufacturer"
            control={control}
            render={({ field }) => <Input placeholder="Ashok Leyland" {...field} />}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            name="vehicleModel"
            control={control}
            render={({ field }) => <Input placeholder="Dost+" {...field} />}
          />
        </div>
