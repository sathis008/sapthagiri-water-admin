 ...
 * Create Driver
 */
export const createDriverThunk =
  createAsyncThunk(
    "driver/createDriver",
 ...
 * Update Driver
 */
export const updateDriverThunk =
  createAsyncThunk(
    "driver/updateDriver",
 ...
 * Delete Driver
 */
export const deleteDriverThunk =
  createAsyncThunk(
    "driver/deleteDriver",
 ...
 */
export const uploadDriverLicenseThunk =
  createAsyncThunk(
    ...
    async (
      ...
      try {
        const response =
          await DriverService.uploadLicense(
            id,
            file
          );
